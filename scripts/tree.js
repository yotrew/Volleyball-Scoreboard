...
{ 
  ...
  if(this.id == 0)
  doc.write("src='" + headImg +"' border=0></a>")
  else
...
function gFld(description, hreference , fontSizes) 
{ 
//doc.write(fontSizes)

  if(!fontSizes)
  	fontSizes="9"
  description="<font style=font-size:"+fontSizes+"pt; font-color: #AABBCC; background-color:#ffffff>" + description
